...
const AboutSection = React.forwardRef(({ showAbout }, ref) => {
    ...
    return (
        <div ref={ref} className={`${showAbout ? 'block' : 'hidden'}`} data-aos="fade-down">
            <div className="p-12 bg-white w-full mt-20" data-aos-delay="200">
            ...
            <div className="p-12 bg-white/25 w-full" data-aos-delay="200">
                <div className="flex-row">
                    <hr className="border-1 border-gray-600 my-4" />
                </div>
                <div className="flex flex-col lg:flex-row justify-between space-x-0 lg:space-x-8 space-y-8 lg:space-y-0" >
                    <div className="flex flex-row w-full lg:w-1/4" data-aos="fade-right" data-aos-delay="200">
                        <h2 className="text-2xl md:text-3xl font-medium">Learning Objectives</h2>
                    </div>
                    <div className="flex flex-row w-full lg:w-1/4" data-aos="fade-right" data-aos-delay="300">
                        <div className="text-primary hover:text-gray-400 mr-4">
                            <UilPlus />
                        ...
                        <div>
                            <h3 className="text-md md:text-lg font-medium">Dynamic Full-Stack Application Development</h3>
                        </div>
                    </div>
                    <div className="flex flex-row w-full lg:w-1/4" data-aos="fade-right" data-aos-delay="400">
                        <div className="text-primary hover:text-gray-400 mr-4">
                        ...
                        <div>
                            <h3 className="text-md md:text-lg font-medium">Seamless API Integration and Data Visualization</h3>
                        </div>
                    </div>
                    <div className="flex flex-row w-full lg:w-1/4" data-aos="fade-right" data-aos-delay="500">
                        <div className="text-primary hover:text-gray-400 mr-4">
                        ...
                        <div>
                            <h3 className="text-md md:text-lg font-medium">Front-end Development, UI/UX and Responsive Design</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <a href="#welcomemessage" className="absolute bottom-2 right-20 flex items-center justify-center hover:text-primary hidden lg:block " data-tooltip-id="BackToTop"><UilArrowCircleUp /></a>
