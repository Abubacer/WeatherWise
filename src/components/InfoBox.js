...
const InfoBox = () => {
    ...
    return (
        <div className="absolute hidden top-36 left-80 right-80 xl:block z-50 bg-background text-textPrimary p-4 shadow-md rounded-2xl w-400 h-600" data-aos="fade">
